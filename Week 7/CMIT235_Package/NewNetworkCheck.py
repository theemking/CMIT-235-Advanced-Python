...
class NewNetworkCheck(NetworkCheck):
    ...
    def getDescriptiveInfo(self, *lists):
        ...
        # Creating a method called callSuper which will takes an array as a parameter.
    def callSuper(self, array7):
        # Calling the parent of NewNetworkCheck’s getMin method.
        min = super().getMin(self.convertList2NpArray(array7))
        print(f"The minimum value result: {min}")
